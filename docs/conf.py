...
project = u'python-twitch-stream'
copyright = u'2015, Jonas Degrave'
...
htmlhelp_basename = 'python-twitch-streamdoc'
...
latex_documents = [
  ('index', 'python-twitch-stream.tex', u'python-twitch-stream Documentation',
   u'Jonas Degrave', 'manual'),
]
